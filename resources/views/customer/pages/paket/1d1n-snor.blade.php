        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 animate-box">
                    <h1><span class="colored">1D1N & Snorkeling</span> Tour</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box" data-animate-effect="fadeIn">
                    <h2>Half Day & Snorkeling Package Tour Nusa Penida</h2>
                </div>
                <div>
                    <div class="container">
                ...
                <div class="col-md-8">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr><td>1. <strong> 2pax </strong> -  IDR Rp.1.140.000,00/pax - 1 Room</td></tr>
                            <tr><td>2. <strong> 3pax </strong> -  IDR Rp.1.100.000,00/pax - 2 Rooms</td></tr>
                            <tr><td>3. <strong> 4pax </strong> -  IDR Rp.1.000.000,00/pax - 2 Rooms</td></tr>
            ...
            <div class="modal-body">
                <table>
					...
					<tbody>
						...
						<tr><td><strong>14.00</strong> : Visit Broken Beach </td></tr>
						<tr><td><strong>14.45</strong> : Visit Angels Billabong </td></tr>
						<tr><td><strong>16.00</strong> : Snorkeling start from Crystal Bay </td></tr>
